...
- Task 12: `CanvasView` importa `MIME_CENARIO` de `./CenariosSoltos` em vez do literal `'application/x-grimorio-cenario'` usado no código do plano — evita duplicar a string do MIME type (pedido do reviewer).
...
- [x] **Step 1: Implementar o comando**
...
```bash
git add grimorio/src-tauri/src/lib.rs docs/superpowers/plans/2026-07-14-cenarios.md
...
- [x] **Step 2: Integrar no CanvasView**
...
- [x] **Step 1: Estilos da aba Conteúdo**
...
- [x] **Step 2: Gate automático completo**
